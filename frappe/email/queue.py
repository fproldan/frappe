...
def prepare_message(email, recipient, recipients_list):
	...
	if frappe.conf.use_ssl and email_account.track_email_status:
		...
		message = message.replace("<!--test email open check test-->", quopri.encodestring('<a hred="{}/api/method/frappe.core.doctype.communication.email.mark_email_as_seen?name={}">Pixe;</a>'.format(get_url(), email.communication).encode()).decode())
	else:
