...
def prepare_message(email, recipient, recipients_list):
	...
	if frappe.conf.use_ssl and email_account.track_email_status:
		...
		message = message.replace("<!--email open check-->", quopri.encodestring('<img src="{}/api/method/frappe.core.doctype.communication.email.mark_email_as_seen"/>'.format(get_url()).encode()).decode()) + '?name={}'.format(email.communication)
	else:
